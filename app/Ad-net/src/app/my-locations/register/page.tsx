...
import { MapPin, Upload, Camera, ChevronRight, ChevronLeft, Check, Info, Ruler, Users, Eye } from "lucide-react"
...
export default function RegisterLocationPage() {
  ...
  const { activeRole, isProviderRegistered } = useRoleStore()
  ...
  useEffect(() => {
    if (!isConnected) {
      toast(
        ...
        { description: "You need to connect your wallet to register a location." },
        "warning",
      )
    ...
    if (activeRole !== "provider") {
      toast(
        ...
        { description: "You need to be in provider mode to register a location." },
        "warning",
      )
      router.push("/dashboard")
      return
    ...
    if (!isProviderRegistered) {
      toast("Register as provider", { description: "You need to register as a provider first." }, "warning")
  ...
  return (
    <div className="container mx-auto px-4 py-8 relative">
      <h1 className="text-3xl md:text-4xl font-black mb-8">REGISTER NEW LOCATION</h1>
      ...
      <div className="border-[6px] border-black bg-white p-6 shadow-[8px_8px_0px_0px_rgba(0,0,0,1)] hover:shadow-[12px_12px_0px_0px_rgba(0,0,0,1)] transition-all duration-300 relative mb-8">
        {/* Decorative elements */}
        <div className="absolute -top-8 -right-8 w-16 h-16 bg-[#FFCC00] border-[4px] border-black rotate-12 hidden md:block"></div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 animate-in fade-in duration-500">
            ...
            <div>
              ...
              <div className="border-[4px] border-black p-4 bg-[#0055FF] text-white">
                ...
                <p className="mb-4">
                  After submission, our team will review your location within 1-2 business days. You'll receive an email
                  notification once your location is approved.
                </p>
