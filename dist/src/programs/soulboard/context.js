...
exports.createSoulboardContext = void 0;
const anchor_1 = require("@coral-xyz/anchor");
const soulboard_json_1 = __importDefault(require("@soulboard/idl/soulboard.json"));
const events_1 = require("@soulboard/core/events");
const errors_1 = require("@soulboard/core/errors");
const provider_1 = require("@soulboard/core/provider");
const transactions_1 = require("@soulboard/core/transactions");
const pdas_1 = require("@soulboard/programs/soulboard/pdas");
const createSoulboardContext = (config) => {
    const provider = (0, provider_1.resolveProvider)(config.provider);
    const programId = config.programId ?? pdas_1.SOULBOARD_PROGRAM_ID;
    const idl = {
        ...soulboard_json_1.default,
...
exports.createSoulboardContext = createSoulboardContext;
