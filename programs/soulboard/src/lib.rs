...
pub mod soulboard {
    ...
    pub fn create_campaign(ctx: Context<CreateCampaign>, campaign_name: String, campaign_description: String, campaign_image_url: String ) -> Result<()> {
        ...
        advertiser.last_campaign_id = advertiser.last_campaign_id
                                                .checked_add(1)
                                                .unwrap();

        advertiser.campaign_count = advertiser.campaign_count
                                                .checked_add(1)
                                                .unwrap();
        Ok(())
    }
